...
So, here we only have one tool! that's a lot less than the whole REST API. so a lot less information to confuse your model. So we can selectively include tools that we need, and leave off the things that we don't. 
...
:::{.notes}
Here's a second tool, for the comments on a ticket. The point is what it does to the response: instead of passing the raw API payload straight through, I strip it down to just what matters for the question I'm asking.
...
## Thank you
<!-- TODO: turn on github pages for this repo -->
