...
<!-- For longer talk: introduce these three points, then switch to code -->
...
{{< qrcode https://modelcontextprotocol.io/ width=300 height=300 >}}
::::
...
<!-- Call back to MCP vs CLI in heading to the conclusion? -->
