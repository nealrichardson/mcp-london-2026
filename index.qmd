...
## {background-image="img/kermit-thinking.jpg"}

<!-- TODO: crop differently -->
...
:::{.notes}
This doesn't work. The first piece is authentication--I can't provide my credentials to connect to the Zendesk API. But even if I could, I would run into other challenges: the Zendesk REST API is not designed for AI agents to make efficient and secure use of it. 
:::
...
## Code is cheap {.center}
<!-- TODO -->

You can write your own easily that does exactly what you need
...
<!-- TODO need to conclude this talk -->
